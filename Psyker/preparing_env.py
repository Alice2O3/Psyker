...
def prepare_environment():
    ...
    torch_command = f"pip install torch=={torch_version} torchvision=={torchvision_version} --no-cache-dir --index-url {torch_index_url}"
    ...
    xformers_command = f"install -U -I --no-deps {xformers_package} --index-url {torch_index_url}"
